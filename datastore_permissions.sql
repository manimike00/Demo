...
GRANT CREATE ON SCHEMA public TO "gisadmin";
GRANT USAGE ON SCHEMA public TO "gisadmin";
...
ALTER DEFAULT PRIVILEGES FOR USER "gisadmin" IN SCHEMA public
...
ALTER VIEW "_table_metadata" OWNER TO "gisadmin";
